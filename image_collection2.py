# -*- coding: utf-8 -*-
"""
Created on Thu Jun 23 23:11:44 2022
...
#==========================================================================================================
#                      Capturing images for the validate data set
#================================================================================================================

images_path2 = 'C:\\Users\\Dr. Sony\\Images\\validate'
...
for label in labels :
    os.makedirs('C:\\Users\\Dr. Sony\\Images\\validate\\' +label)
    ...
    for imgnum in range(number_imgs):
        ...
        imagename = os.path.join(images_path2,label, label+ '.'+'{}.jpg'.format(str(uuid.uuid1())))
